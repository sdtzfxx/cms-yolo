...
from models.ODConv import Attention,ODConv2d
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC, 
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC,ODConv2d,SPPCSPC_att,Conv_att1,Conv_att2,
                 DySnakeConv,GSConv,VoVGSCSP,VoVGSCSPC,AKConv,AIFI,SCConv,RFAConv,RFAConv_7,RepNCSPELAN4,ScConv,ADown,C2f]:
            c1, c2 = ch[f], args[0]
            ...
            if m in [DownC, SPPCSPC, GhostSPPCSPC, 
                     ...
                     ST2CSPA, ST2CSPB, ST2CSPC,space_to_depth,C2f]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='E:\qj\yolov7-main\cfg\\training\yolov7a-p2+Inner+carafe+spd.yaml', help='model.yaml')
