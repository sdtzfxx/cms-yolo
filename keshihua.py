...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_dir', default='D:\yolov7-main\VisDrone2019\images\\train')
    parser.add_argument('--label_dir', default='D:\yolov7-main\VisDrone2019\labelx\\train')
    parser.add_argument('--class_names', default=[ 'pedestrian', 'people', 'bicycle', 'car', 'van', 'truck', 'tricycle', 'awning-tricycle', 'bus', 'motor'])
